...
knitr::opts_chunk$set(echo = TRUE, warning = FALSE,message = FALSE,tidy=TRUE,fig.path = "figs/",fig.keep=TRUE)
...
```{r}
# read all journal dat (this is not in github repo yet)
jdata_all <- read_excel("../../Data-Sharing-Policies.xlsx", sheet = "2014 ESI Data",
                    na = "N/A")
