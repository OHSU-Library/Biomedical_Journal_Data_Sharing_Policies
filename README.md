...
The rubric and raw data is found in [Data-Sharing-Policies_2016-10-31.xlsx](Data-Sharing-Policies_2016-10-31.xlsx).
...
Both html reports can be reproduced by running the [render-analysis-report.R](analysis-code/render-analysis-report.R) file.
